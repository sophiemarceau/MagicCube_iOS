...
- (void)setUpGoodsDict:(NSDictionary *)dataDict{
    ...
    self.distrubePriceLabel.frame = CGRectMake(SCALE_W(173), SCALE_W(132), SCREEN_WIDTH - SCALE_W(173) - SCALE_W(20) - SCALE_W(14), 8.5);
...
- (RedButton *)priceBtn{
    if (!_priceBtn) {
        _priceBtn = [[RedButton alloc] initWithFrame:CGRectMake(SCALE_W(245), SCALE_W(78), SCALE_W(100), SCALE_W(23))];
...
- (MagicLineView *)lineView{
    if (!_lineView) {
        _lineView = [[MagicLineView alloc] initWithFrame:CGRectMake(SCALE_W(173), SCALE_W(105.5), SCREEN_WIDTH - SCALE_W(20) - SCALE_W(20) - SCALE_W(173), 0.5)];
