...
@property (nonatomic,strong) UIButton *codeMessageBtn,*wechatBtn;
...
-(UIButton *)registerBtn{
    if (_registerBtn == nil) {
        ...
        [_registerBtn addTarget:self action:@selector(loginOnclick:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _registerBtn;
}
