...
/******相关颜色设置*******/
//中间提示语 颜色
#define SW_TextColor GrayMagicColor
//进度条 颜色
#define SW_ProgressColor GrayMagicColor
//默认圆
#define SW_CircleLineColor GrayMagicColor
...
- (void)drawRect:(CGRect)rect {
    ...
    CGSize textSize = [textContent sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:SCALE_W(SW_FontSize)]}];
    
    CGRect textRect = CGRectMake(rect.size.width / 2 - textSize.width / 2,
                                 rect.size.height / 2 - textSize.height / 2,
                                 textSize.width , textSize.height);
    
    [textContent drawInRect:textRect withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:SCALE_W(SW_FontSize)], NSForegroundColorAttributeName:self.textColor}];
